...
<span class="col-sm-3 col-md-3 hidden-sm-down sort-by">{l s='SORTUJ:' d='Shop.Theme.Global'}</span>
<div  class="{if !empty($listing.rendered_facets)}col-sm-9 col-xs-8{else}col-sm-12 col-xs-12{/if} col-md-9 products-sort-order dropdown">
  <button
    ...
    <i class="fa fa-angle-down" style="font-size:12px; position:absolute; right:39px; top:5px"></i>
  </button>
