  ...
  <section id="main1">
    ...
    <a href="" class="back-link">&lt; Wróć do kategorii</a>
      <div class="col-md-6" id="produkt_lewo">
        ...
        <div class="col-md-6" id="produkt_prawo">
          {block name='page_header_container'}
            {block name='page_header'}
              <h1 class="h1" id="nazwa2">{block name='page_title'}{$product.name}{/block}</h1>
            {/block}
          {/block}
                       ...
                       <section class="product-attachments">
                         ...
                         <br><br>
                           <div class="attachment">
                             <a id="att"
                              href="{url entity='attachment' params=['id_attachment' => $attachment.id_attachment]}"><i class="fa-regular fa-file-pdf" ></i></i></a>
    ...
    {block name='product_accessories'}
      {if $accessories}
        <section class="product-accessories clearfix"  id="powiazane">
          <p class="h5 text-uppercase" id="prod_pow">{l s='PRODUKTY POWIĄZANE' d='Shop.Theme.Catalog'}</p>
