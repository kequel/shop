...
<div id="post-product-comment-modal" class="modal fade product-comment-modal" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <button style="position:absolute; top:-2px; right:2px;" type="button" class="close" data-dismiss="modal" aria-label="{l s='Close' d='Shop.Theme.Global'}">
          <span aria-hidden="true">&times;</span>
        </button>
        <p class="col-sm-12">{l s='Write your review' d='Modules.Productcomments.Shop'}</p>
      ...
      <div class="modal-body">
        <form id="post-product-comment-form" action="{$post_comment_url nofilter}" method="POST">
          <div class="row">
            ...
            <div class="col-sm-12" id="gwiazdki">
          ...
          {if !$logged}
            <div class="row" style="visibility: hidden; position:absolute; top:-200px">
              <div class="col-sm-8">
                <label class="form-label"  for="comment_title">{l s='Title' d='Modules.Productcomments.Shop'}<sup class="required">*</sup></label>
                <input id="comment_title" value="x" name="comment_title" type="text" value=""/>
              </div>
              <div class="col-sm-4">
                <label class="form-label" value="" for="customer_name">{l s='Your name' d='Modules.Productcomments.Shop'}<sup class="required">*</sup></label>
                <input id="customer_name" value="x" name="customer_name" type="text" value=""/>
              </div>
            </div>
          {else}
          
            <input id="comment_title" value="x" name="comment_title" type="text"  style="visibility: hidden; position:absolute; top:-200px"/>
          {/if}

          <label class="form-label" for="comment_content">{l s='Twoja recenzja' d='Modules.Productcomments.Shop'}<sup class="required">*</sup></label>
          ...
          <div class="row">
            ...
            <div class="col-sm-12 post-comment-buttons">
               <button type="submit" id="su" class="btn btn-comment btn-comment-big">
                {l s='Send' d='Modules.Productcomments.Shop'}
              </button>
              <p class="btn">
              lub
              </p>
              <button type="button" id="an" class="btn btn-comment btn-comment-big" data-dismiss="modal">
